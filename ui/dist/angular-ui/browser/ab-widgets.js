...
(function () {
  ...
  function styleOnce() {
    ...
    s.textContent =
      ...
      'body.ab-has-sticky{padding-bottom:60px!important}';
    document.head.appendChild(s);
  }
  ...
  function isCartLike() {
    ...
    if (p.indexOf('cart') !== -1 || p.indexOf('checkout') !== -1 || p.indexOf('order') !== -1) return true;
