...
let BrandService = BrandService_1 = class BrandService {
    constructor(brandModel, productModel, configService, utilsService) {
    ...
    async addBrand(addBrandDto) {
        ...
        const mData = Object.assign(Object.assign({}, addBrandDto), defaultData);
    ...
    async insertManyBrand(addBrandsDto, optionBrandDto) {
    ...
    async getAllBrands(filterBrandDto, searchQuery) {
    ...
    async updateBrandById(id, updateBrandDto) {
        ...
        try {
            const finalData = Object.assign({}, updateBrandDto);
            if (name)
    ...
    async updateMultipleBrandById(ids, updateBrandDto) {
    ...
    async deleteMultipleBrandById(ids, checkUsage) {
        try {
            const mIds = ids.map((m) => new ObjectId(m));
