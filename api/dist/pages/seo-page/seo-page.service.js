...
var SeoPageService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.SeoPageService = void 0;
...
let SeoPageService = SeoPageService_1 = class SeoPageService {
    constructor(seoPageModel, productModel, configService, utilsService) {
        this.seoPageModel = seoPageModel;
        this.productModel = productModel;
        this.configService = configService;
        this.utilsService = utilsService;
        this.logger = new common_1.Logger(SeoPageService_1.name);
    }
    async addSeoPage(addSeoPageDto) {
        ...
        const mData = Object.assign(Object.assign({}, addSeoPageDto), defaultData);
    ...
    async insertManySeoPage(addSeoPagesDto, optionSeoPageDto) {
    ...
    async getAllSeoPages(filterSeoPageDto, searchQuery) {
    ...
    async updateSeoPageById(id, updateSeoPageDto) {
        ...
        try {
            const finalData = Object.assign({}, updateSeoPageDto);
            if (name)
    ...
    async updateMultipleSeoPageById(ids, updateSeoPageDto) {
        const mIds = ids.map((m) => new ObjectId(m));
        if (updateSeoPageDto.slug) {
            delete updateSeoPageDto.slug;
        }
        try {
            await this.seoPageModel.updateMany({ _id: { $in: mIds } }, { $set: updateSeoPageDto });
            return {
                success: true,
                message: 'Success',
            };
    ...
    async deleteSeoPageById(id, checkUsage) {
        ...
        try {
            ...
            if (checkUsage) {
                ...
                await this.productModel.updateMany({ 'seoPage._id': new ObjectId(id) }, { $set: resetSeoPage });
            }
            return {
                success: true,
                message: 'Success',
    ...
    async deleteMultipleSeoPageById(ids, checkUsage) {
        try {
            const mIds = ids.map((m) => new ObjectId(m));
            ...
            if (checkUsage) {
                ...
                await this.productModel.updateMany({ 'seoPage._id': { $in: mIds } }, { $set: resetSeoPage });
            }
            return {
                success: true,
                message: 'Success',
...
SeoPageService = SeoPageService_1 = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)('SeoPage')),
...
exports.SeoPageService = SeoPageService;
//# sourceMappingURL=seo-page.service.js.map