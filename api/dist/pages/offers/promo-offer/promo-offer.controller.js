...
var PromoOfferController_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.PromoOfferController = void 0;
...
const promo_offer_dto_1 = require("../../../dto/promo-offer.dto");
let PromoOfferController = PromoOfferController_1 = class PromoOfferController {
    constructor(promoOfferService) {
        this.promoOfferService = promoOfferService;
        this.logger = new common_1.Logger(PromoOfferController_1.name);
    }
    async addPromoOffer(addPromoOfferDto) {
        return await this.promoOfferService.addPromoOffer(addPromoOfferDto);
    }
    async insertManyPromoOffer(body) {
        return await this.promoOfferService.insertManyPromoOffer(body.data, body.option);
    }
    async getAllPromoOffers(filterPromoOfferDto, searchString) {
    ...
    async updateMultiplePromoOfferById(updatePromoOfferDto) {
    ...
    async deleteMultiplePromoOfferById(data, checkUsage) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [promo_offer_dto_1.AddPromoOfferDto]),
    __metadata("design:returntype", Promise)
], PromoOfferController.prototype, "addPromoOffer", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], PromoOfferController.prototype, "insertManyPromoOffer", null);
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [promo_offer_dto_1.FilterAndPaginationPromoOfferDto, String]),
    __metadata("design:returntype", Promise)
], PromoOfferController.prototype, "getAllPromoOffers", null);
__decorate([
    (0, common_1.Version)(common_1.VERSION_NEUTRAL),
    ...
    __metadata("design:returntype", Promise)
], PromoOfferController.prototype, "getPromoOfferSingle", null);
__decorate([
    (0, common_1.Version)(common_1.VERSION_NEUTRAL),
    (0, common_1.Get)('/:id'),
    ...
    __metadata("design:returntype", Promise)
], PromoOfferController.prototype, "getPromoOfferById", null);
__decorate([
    (0, common_1.Version)(common_1.VERSION_NEUTRAL),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, promo_offer_dto_1.UpdatePromoOfferDto]),
    __metadata("design:returntype", Promise)
], PromoOfferController.prototype, "updatePromoOfferById", null);
__decorate([
    (0, common_1.Version)(common_1.VERSION_NEUTRAL),
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [promo_offer_dto_1.UpdatePromoOfferDto]),
    __metadata("design:returntype", Promise)
], PromoOfferController.prototype, "updateMultiplePromoOfferById", null);
__decorate([
    (0, common_1.Version)(common_1.VERSION_NEUTRAL),
    ...
    __metadata("design:returntype", Promise)
], PromoOfferController.prototype, "deletePromoOfferById", null);
__decorate([
    (0, common_1.Version)(common_1.VERSION_NEUTRAL),
    ...
    __metadata("design:returntype", Promise)
], PromoOfferController.prototype, "deleteMultiplePromoOfferById", null);
PromoOfferController = PromoOfferController_1 = __decorate([
    (0, common_1.Controller)('promo-offer'),
    __metadata("design:paramtypes", [promo_offer_service_1.PromoOfferService])
], PromoOfferController);
exports.PromoOfferController = PromoOfferController;
//# sourceMappingURL=promo-offer.controller.js.map