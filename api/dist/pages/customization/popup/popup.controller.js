...
let PopupController = PopupController_1 = class PopupController {
    constructor(popupService) {
        this.popupService = popupService;
        this.logger = new common_1.Logger(PopupController_1.name);
    }
    async addPopup(addPopupDto) {
        return await this.popupService.addPopup(addPopupDto);
    }
    async insertManyPopup(body) {
        return await this.popupService.insertManyPopup(body.data, body.option);
    }
    async getAllPopups(filterPopupDto, searchString) {
    ...
    async updateMultiplePopupById(updatePopupDto) {
        return await this.popupService.updateMultiplePopupById(updatePopupDto.ids, updatePopupDto);
    }
    async deletePopupById(id, checkUsage) {
        return await this.popupService.deletePopupById(id, Boolean(checkUsage));
    }
    async deleteMultiplePopupById(data, checkUsage) {
        return await this.popupService.deleteMultiplePopupById(data.ids, Boolean(checkUsage));
    }
};
__decorate([
    (0, common_1.Post)('/add'),
    ...
    __metadata("design:paramtypes", [popup_dto_1.AddPopupDto]),
    __metadata("design:returntype", Promise)
], PopupController.prototype, "addPopup", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], PopupController.prototype, "insertManyPopup", null);
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [popup_dto_1.FilterAndPaginationPopupDto, String]),
    __metadata("design:returntype", Promise)
], PopupController.prototype, "getAllPopups", null);
__decorate([
    (0, common_1.Version)(common_1.VERSION_NEUTRAL),
    (0, common_1.Get)('/:id'),
    (0, admin_roles_decorator_1.AdminMetaRoles)(admin_roles_enum_1.AdminRoles.SUPER_ADMIN, admin_roles_enum_1.AdminRoles.ADMIN, admin_roles_enum_1.AdminRoles.EDITOR),
    ...
    __metadata("design:returntype", Promise)
], PopupController.prototype, "getPopupById", null);
__decorate([
    (0, common_1.Version)(common_1.VERSION_NEUTRAL),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, popup_dto_1.UpdatePopupDto]),
    __metadata("design:returntype", Promise)
], PopupController.prototype, "updatePopupById", null);
__decorate([
    (0, common_1.Version)(common_1.VERSION_NEUTRAL),
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [popup_dto_1.UpdatePopupDto]),
    __metadata("design:returntype", Promise)
], PopupController.prototype, "updateMultiplePopupById", null);
__decorate([
    (0, common_1.Version)(common_1.VERSION_NEUTRAL),
    ...
    __metadata("design:returntype", Promise)
], PopupController.prototype, "deletePopupById", null);
__decorate([
    (0, common_1.Version)(common_1.VERSION_NEUTRAL),
    ...
    __metadata("design:returntype", Promise)
], PopupController.prototype, "deleteMultiplePopupById", null);
