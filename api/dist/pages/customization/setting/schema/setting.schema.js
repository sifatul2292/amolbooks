...
const sub_schema_schema_1 = require("../../../../schema/sub-schema.schema");
exports.SettingSchema = new mongoose.Schema({
    ...
    deliveryCharges: [sub_schema_schema_1.DELIVERY_CHARGE_SETTING],
    paymentMethods: [sub_schema_schema_1.PAYMENT_METHOD_SETTING],
    advancePayment: [sub_schema_schema_1.ADVANCE_PAYMENT_SETTING],
    smsMethods: [sub_schema_schema_1.SMS_METHOD_SETTING],
    courierMethods: [sub_schema_schema_1.COURIER_METHOD_SETTING],
    chats: [sub_schema_schema_1.CHAT_SETTING],
    currency: {
        name: {
            type: String,
            required: false,
