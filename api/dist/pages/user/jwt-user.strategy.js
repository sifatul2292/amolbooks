...
let JwtUserStrategy = class JwtUserStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy, global_variables_1.PASSPORT_USER_TOKEN_TYPE) {
    constructor(configService) {
        super({
            jwtFromRequest: passport_jwt_1.ExtractJwt.fromAuthHeaderAsBearerToken(),
            ignoreExpiration: false,
            secretOrKey: configService.get('userJwtSecret'),
        });
