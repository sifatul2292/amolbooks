...
let GalleryService = GalleryService_1 = class GalleryService {
    constructor(galleryModel, configService, utilsService) {
    ...
    async addGallery(addGalleryDto) {
        ...
        const mData = Object.assign(Object.assign({}, addGalleryDto), defaultData);
    ...
    async insertManyGallery(addGallerysDto, optionGalleryDto) {
    ...
    async getAllGalleries(filterGalleryDto, searchQuery) {
    ...
    async updateGalleryById(id, updateGalleryDto) {
        ...
        try {
            const finalData = Object.assign({}, updateGalleryDto);
            if (name)
    ...
    async updateMultipleGalleryById(ids, updateGalleryDto) {
    ...
    async deleteMultipleGalleryById(ids) {
        try {
